...
m_work_order_line.*, qty_production, m_work_order.create_date, m_work_order.update_date, auc.user_fullname, auu.user_fullname user_fullname_u
FROM m_work_order
...
if ($_REQUEST['mode'] == 'export-all') {
    ...
    header("Content-Disposition: attachment; filename=\"work-order-" . date("Y-m-d") . ".csv\"");
    echo "\"NO. WO\"";
    echo ",\"TANGGAL WO\"";
    echo ",\"NO. SC\"";
