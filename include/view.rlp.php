...
echo "<div class='title'>Request Long Pipe</div>";

function grid_so($data) {
    $href = "module.php?m=trx.so&back_to=view.rlp&mode=view&pkey[c_order_id]={$data['record']['c_order_id']}";
...
if (is_array($_SESSION[$GLOBALS['APP_ID']]['view.rlp']['columns'])) {
    $cgx_def_columns = $_SESSION[$GLOBALS['APP_ID']]['view.rlp']['columns'];
} else {
    ...
    $_SESSION[$GLOBALS['APP_ID']]['view.rlp']['columns'] = $cgx_def_columns;
}

$cgx_sql = "SELECT m_work_order.document_no, m_work_order.order_date,
            c_order.document_no so_number, c_order.order_date s_order_date, COALESCE(remark,c_forecast.document_no) remark, reference_no, 
            ...
            mat.product_code product_codem, mat.product_name product_namem, mat.spec specm, mat.od odm, mat.thickness thicknessm, mat.length lengthm,
            ...
            LEFT JOIN app_user auu ON (m_work_order.update_user=auu.user_id) WHERE m_work_order.type_id = 'R' ";
$cgx_sql .= " AND " . org_filter_trx('m_work_order.app_org_id');

$cgx_sqltotal = "SELECT sum(material_quantity) as material_quantity, sum(producted_quantity) as producted_quantity,
...
echo "      <td align='right'>Tgl. Requst</td>\n";
...
echo "<input type='hidden' name='dg_name' value='view.rlp'>\n";
...
echo "          <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input disabled checked id='col_document_no' name='col[document_no]' type='checkbox'></td><td width='99%'><label for='col_document_no'>No. Request</label></td></tr></table>\n";
echo "          <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input disabled checked id='col_order_date' name='col[order_date]' type='checkbox'></td><td width='99%'><label for='col_order_date'>Tgl Request</label></td></tr></table>\n";
...
echo "          <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['length'] == 1 ? ' checked' : '') . " id='col_length' name='col[length]' type='checkbox'></td><td width='99%'><label for='col_length'>Length Cut</label></td></tr></table>\n";
...
echo "          <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['specm'] == 1 ? ' checked' : '') . " id='col_specm' name='col[specm]' type='checkbox'></td><td width='99%'><label for='col_specm'>Spec LP</label></td></tr></table>\n";
...
echo "          <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['material_quantity'] == 1 ? ' checked' : '') . " id='col_material_quantity' name='col[material_quantity]' type='checkbox'></td><td width='99%'><label for='col_material_quantity'>Qty Request</label></td></tr></table>\n";
...
echo "          <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['producted_quantity'] == 1 ? ' checked' : '') . " id='col_producted_quantity' name='col[producted_quantity]' type='checkbox'></td><td width='99%'><label for='col_producted_quantity'>Qty Penerimaan</label></td></tr></table>\n";
...
function exportCSV() {
    ...
    form.setAttribute("action", "action/view.rlp.php");
...
if ($item_number) $cgx_sql .= " AND (mat.product_code LIKE '%" . mysql_escape_string($item_number) . "%' OR mat.product_name LIKE '%" . mysql_escape_string($item_number) . "%' OR mat.description LIKE '%" . mysql_escape_string($item_number) . "%')";
...
if ($item_number) $cgx_sqltotal .= " AND (mat.product_code LIKE '%" . mysql_escape_string($item_number) . "%' OR mat.product_name LIKE '%" . mysql_escape_string($item_number) . "%' OR mat.description LIKE '%" . mysql_escape_string($item_number) . "%')";
...
if ($cgx_def_columns['document_no'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('No. Request LP', 'document_no', 'document_no', array('align' => 'left'), NULL, NULL));
if ($cgx_def_columns['order_date'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Tgl Request', 'order_date', 'order_date', array('align' => 'center'), NULL, "cgx_format_date()"));
...
if ($cgx_def_columns['length'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Length Cut', 'length', 'length', array('align' => 'left'), NULL, NULL));
...
if ($cgx_def_columns['specm'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Spec LP', 'specm', 'specm', array('align' => 'left'), NULL, NULL));
...
if ($cgx_def_columns['material_quantity'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Qty Request', 'material_quantity', 'material_quantity', array('align' => 'right'), NULL, "cgx_format_3digit()"));
...
if ($cgx_def_columns['producted_quantity'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Qty Penerimaan', 'producted_quantity', 'producted_quantity', array('align' => 'right'), NULL, "cgx_format_3digit()"));
...
echo "</td></tr></table>\n";
    ...
    // echo "  </tr>";
    echo "  <tr>";
    echo "      <td><b>QTY Request</b></td>";
    echo "      <td width='10' align='center'>:</td>";
    echo "      <td align='right'><b>".  number_format($cgx_data_sum["material_quantity"], 2)."</b></td>";
    echo "      <td width='100px;'>&nbsp;</td>";
    echo "  </tr>"; 
    echo "  <tr>";
    echo "      <td><b>QTY Penerimaan</b></td>";
    echo "      <td width='10' align='center'>:</td>";
