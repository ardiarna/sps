...
echo "<div class='title'>".title_header('view.bm', org())."</div>";

function grid_so($data) {
    $href = "module.php?m=trx.so&back_to=view.bm&mode=view&pkey[c_order_id]={$data['record']['c_order_id']}";
...
if (is_array($_SESSION[$GLOBALS['APP_ID']]['view.bm']['columns'])) {
    $cgx_def_columns = $_SESSION[$GLOBALS['APP_ID']]['view.bm']['columns'];
} else {
    ...
    $_SESSION[$GLOBALS['APP_ID']]['view.bm']['columns'] = $cgx_def_columns;
}

$cgx_sql = "SELECT m_inout.dokumen, m_inout.document_no, m_inout.m_inout_date, m_inout.dokumen, m_inout.c_order_id, c_order.remark so_number, m_inout_line.*, 
m_product.*, warehouse_name, quantity, partner_code, partner_name, m_inout.create_date createdate, m_inout.update_date, auc.user_fullname, auu.user_fullname user_fullname_u
FROM m_inout
...
echo "<input type='hidden' name='dg_name' value='view.bm'>\n";
...
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['dokumen'] == 1 ? ' checked' : '') . " id='col_dokumen' name='col[dokumen]' type='checkbox'></td><td width='99%'><label for='col_dokumen'>No W/O</label></td></tr></table>\n";
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['so_number'] == 1 ? ' checked' : '') . " id='col_so_number' name='col[so_number]' type='checkbox'></td><td width='99%'><label for='col_so_number'>Remark</label></td></tr></table>\n";
...
function exportCSV() {   
    ...
    form.setAttribute("action", "action/view.bm.php");
    ...
    hiddenField.setAttribute("value", "<?php echo title_header('view.bm', org()); ?>");
    form.appendChild(hiddenField);
