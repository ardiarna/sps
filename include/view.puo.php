...
echo "<div class='title'>Purchase Order Detail</div>";
...
if (is_array($_SESSION[$GLOBALS['APP_ID']]['view.puo']['columns'])) {
    $cgx_def_columns = $_SESSION[$GLOBALS['APP_ID']]['view.puo']['columns'];
} else {
    ...
    $_SESSION[$GLOBALS['APP_ID']]['view.puo']['columns'] = $cgx_def_columns;
}
...
JOIN m_product USING (m_product_id) WHERE 1 = 1 AND m_transaction_type_id = '2'";
if (org() != '1') {  
$cgx_sql .= " AND " . org_filter_trx('c_order.app_org_id');
}

//print_r($cgx_sql);
$cgx_sqltotal = "SELECT sum(order_weight) as order_weight, sum(return_quantity) as return_quantity, 
    sum(receipt_weight) as receipt_weight, sum(order_weight-receipt_weight+return_quantity) as outstanding 
...
echo "</tr><tr>";
echo "<td align='right'>Contract Number</td>\n";
...
echo "<td align='right'>Jadwal Penerimaan</td>\n";
...
echo "<input type='hidden' name='dg_name' value='view.puo'>\n";
...
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['partner_code'] == 1 ? ' checked' : '') . " id='col_partner_code' name='col[partner_code]' type='checkbox'></td><td width='99%'><label for='col_partner_code'>Kode Vendor</label></td></tr></table>\n";

echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['partner_name'] == 1 ? ' checked' : '') . " id='col_partner_name' name='col[partner_name]' type='checkbox'></td><td width='99%'><label for='col_partner_name'>Vendor</label></td></tr></table>\n";
...
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['od'] == 1 ? ' checked' : '') . " id='col_od' name='col[od]' type='checkbox'></td><td width='99%'><label for='col_od'>Width</label></td></tr></table>\n";
...
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['schedule_delivery_date'] == 1 ? ' checked' : '') . " id='col_schedule_delivery_date' name='col[schedule_delivery_date]' type='checkbox'></td><td width='99%'><label for='col_schedule_delivery_date'>Jadwal Penerimaan</label></td></tr></table>\n";

echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['order_weight'] == 1 ? ' checked' : '') . " id='col_order_weight' name='col[order_weight]' type='checkbox'></td><td width='99%'><label for='col_order_weight'>Jumlah Berat</label></td></tr></table>\n";
...
function exportCSV() {   
    ...
    form.setAttribute("action", "action/view.puo.php");
...
if ($cgx_def_columns['partner_code'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Kode Vendor', 'partner_code', 'partner_code', array('align' => 'left'), NULL, NULL));
...
if ($cgx_def_columns['schedule_delivery_date'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Jadwal Penerimaan', 'schedule_delivery_date', 'schedule_delivery_date', array('align' => 'center'), NULL, "cgx_format_date()"));

if ($cgx_def_columns['order_weight'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Berat Order (Kg)', 'order_weight', 'order_weight', array('align' => 'right'), NULL, "cgx_format_3digit()"));

if ($cgx_def_columns['order_weight'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Berat Diterima (Kg)', 'receipt_weight', 'receipt_weight', array('align' => 'right'), NULL, "cgx_format_3digit()"));

if ($cgx_def_columns['order_weight'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Outstanding (Kg)', 'outstanding', array('align' => 'right'), NULL, "cgx_format_3digit()"));
...
//-----------------------------------------------------------------------------------------------------------------------------------
    ...
    echo "      <td align='right'><b>".  number_format($cgx_data_sum["order_weight"], 2)."</b></td>";
    echo "      <td width='100px;'>&nbsp;</td>";
    echo "  </tr>"; 
    echo "  <tr>";
    echo "      <td><b>Total Delivery</b></td>";
    echo "      <td width='10' align='center'>:</td>";
    echo "      <td align='right'><b>".  number_format($cgx_data_sum["receipt_weight"], 2)."</b></td>";
    echo "  </tr>"; 
    echo "  <tr>";
