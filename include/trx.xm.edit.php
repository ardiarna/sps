...
if ($_REQUEST['mode'] == 'edit' && $_SESSION[$APP_ID]['xm']['m_box_inout_id'] == $_REQUEST['pkey']['m_box_inout_id']) {
    $data = $_SESSION[$APP_ID]['xm'];
} else {
...
if ($_REQUEST['mode'] == 'edit') {
    ...
    echo "<input type='button' value='Simpan Dokumen' onclick=\"xajax_saveXM(xajax.getFormValues('frmXM'));\">";
    echo "<input type='button' value='Tambah Box' onclick=\"popupReference('box-outside');\">";
    ...
    echo "<input type='button' value='Cetak' onclick=\"window.location = 'report.php?path=/reports/SPS/Tanda_Terima_Box&param[REPORT_ID_BOX_MASUK]={$data['m_box_inout_id']}&type=docx&fname={$data['m_box_inout_id']}'\">";
    echo "</div>";
}
