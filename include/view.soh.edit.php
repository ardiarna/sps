...
// echo "<td width='10%'></td>";
// echo "<td width='12%'>Reference</td>";
// echo "<td width='33%'><input{$readonly} name='reference' type='text' size='30' value=\"{$data['reference_no']}\"></td>";
// echo "</tr>";
// echo "<tr>";
...
// echo "<td></td>";
// echo "<td>Status</td>";
// echo "<td><input{$readonly} type='text' size='10' value=\"" . ($data['status'] == 'O' ? 'Open' : 'Close') . "\"></td>";
// echo "</tr>";
// echo "</table>";
// echo "</form>";
// echo "</div>";
