...
if (is_array($_SESSION[$GLOBALS['APP_ID']]['view.xk']['columns'])) {
    $cgx_def_columns = $_SESSION[$GLOBALS['APP_ID']]['view.xk']['columns'];
} else {
    ...
    $_SESSION[$GLOBALS['APP_ID']]['view.xk']['columns'] = $cgx_def_columns;
}
...
echo "<td></td>\n";
echo "<td width='20'></td>\n";
//echo "<td width='1' class='datagrid_bar_icon'><a title='Export semua data ke CSV' href='action/view.xk.php?mode=export-all'><img border='0' src='images/icon_csv.png'></a></td>\n";
...
echo "<input type='hidden' name='dg_name' value='view.xk'>\n";
...
if ($_SESSION[$GLOBALS['APP_ID']]['view.xk']['error']) {
    echo "<div class='error'>{$_SESSION[$GLOBALS['APP_ID']]['view.xk']['error']}</div>";
    unset($_SESSION[$GLOBALS['APP_ID']]['view.xk']['error']);
}

if ($_SESSION[$GLOBALS['APP_ID']]['view.xk']['info']) {
    echo "<div class='info'>{$_SESSION[$GLOBALS['APP_ID']]['view.xk']['info']}</div>";
    unset($_SESSION[$GLOBALS['APP_ID']]['view.xk']['info']);
}
