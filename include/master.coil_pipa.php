...
echo "<div class='title'>Master Data Coil - Pipa </div>";
...
if (strlen($_REQUEST['pkey']['m_material_requirement_id']) > 0) {
    ...
    $selectLP = "<img onclick=\"popupReferenceAmbil('product-category','&p1=L');\" 
                       style='cursor: pointer; vertical-align: bottom;' src='images/icon_reference.png'>";
    $selectSLIT = "<img onclick=\"popupReferenceAmbil('product_category','&p1=S');\" 
                 style='cursor: pointer; vertical-align: bottom;' src='images/icon_reference.png'>";
    ...
    echo "    <li class='even'>\n";
    echo "        <label class='cgx_form' for='data_name_product_fg'>Product Long Pipe</label>\n";
    echo "        <input id='name_product_fg' type='text' value=\"{$cgx_data['name_product_fg']}\" size='50' maxlength='100' style='text-align: left;' />{$selectLP}\n"; 
    echo "    </li>\n";
    echo "    <input type='hidden' name='type[name_product_material]' value='T'>";
    echo "    <li class='odd'>\n";
    echo "        <label class='cgx_form' for='data_name_product_material'>Product Slitting</label>\n";
    echo "        <input id='name_product_material' type='text' value=\"{$cgx_data['name_product_material']}\" size='50' maxlength='100' style='text-align: left;' />{$selectSLIT}\n";
    echo "    </li>\n";
    echo "    <li class='even'>\n";
...
//print_r($p1); print_r($p2); exit;
    ...
    echo "                  <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['m_material_requirement_id'] == 1 ? ' checked' : '') . " id='col_m_material_requirement_id' name='col[m_material_requirement_id]' type='checkbox'></td><td width='99%'><label for='col_m_material_requirement_id'>ID Coil Pipa Req</label></td></tr></table>\n";
    echo "                  <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['m_product_fg'] == 1 ? ' checked' : '') . " id='col_m_product_fg' name='col[m_product_fg]' type='checkbox'></td><td width='99%'><label for='col_m_product_fg'>ID Long Pipe</label></td></tr></table>\n";
    echo "                  <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['product_code_fg'] == 1 ? ' checked' : '') . " id='col_product_code_fg' name='col[product_code_fg]' type='checkbox'></td><td width='99%'><label for='col_product_code_fg'>Item Number Long Pipe</label></td></tr></table>\n";
    echo "                  <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['name_product_fg'] == 1 ? ' checked' : '') . " id='col_name_product_fg' name='col[name_product_fg]' type='checkbox'></td><td width='99%'><label for='col_name_product_fg'>Product Long Pipe</label></td></tr></table>\n";
    echo "                  <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['m_product_material'] == 1 ? ' checked' : '') . " id='col_m_product_material' name='col[m_product_material]' type='checkbox'></td><td width='99%'><label for='col_m_product_material'>ID Slitting</label></td></tr></table>\n";
    echo "                  <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['product_code_mat'] == 1 ? ' checked' : '') . " id='col_product_code_mat' name='col[product_code_mat]' type='checkbox'></td><td width='99%'><label for='col_product_code_mat'>Item Number Slitting</label></td></tr></table>\n";
    echo "                  <table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['name_product_material'] == 1 ? ' checked' : '') . " id='col_name_product_material' name='col[name_product_material]' type='checkbox'></td><td width='99%'><label for='col_name_product_material'>Product Slitting</label></td></tr></table>\n";
    echo "              </td>\n";
...
<?php
    ...
    if ($cgx_def_columns['m_material_requirement_id'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('ID Coil Pipa Req', 'm_material_requirement_id', 'm_material_requirement_id', array('align' => 'right'), NULL, NULL));
    if ($cgx_def_columns['m_product_fg'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('ID Long Pipe', 'm_product_fg', 'm_product_fg', array('align' => 'right'), NULL, NULL));
    if ($cgx_def_columns['product_code_fg'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Item Number Long Pipe', 'product_code_fg', 'product_code_fg', array('align' => 'left'), NULL, NULL));
    if ($cgx_def_columns['name_product_fg'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Product Long Pipe', 'name_product_fg', 'name_product_fg', array('align' => 'left'), NULL, NULL));
    if ($cgx_def_columns['m_product_material'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('ID Slitting', 'm_product_material', 'm_product_material', array('align' => 'right'), NULL, NULL));
    if ($cgx_def_columns['product_code_mat'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Item Number Slitting', 'product_code_mat', 'product_code_mat', array('align' => 'left'), NULL, NULL));
    if ($cgx_def_columns['name_product_material'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Product Slitting', 'name_product_material', 'name_product_material', array('align' => 'left'), NULL, NULL));
