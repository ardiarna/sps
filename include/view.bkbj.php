...
echo "<div class='title'>".title_header('view.bkbj', org())."</div>";

require_once 'Structures/DataGrid.php';
require_once 'HTML/Table.php';

if (is_array($_SESSION[$GLOBALS['APP_ID']]['view.bkbj']['columns'])) {
    $cgx_def_columns = $_SESSION[$GLOBALS['APP_ID']]['view.bkbj']['columns'];
} else {
    ...
    $_SESSION[$GLOBALS['APP_ID']]['view.bkbj']['columns'] = $cgx_def_columns;
}
...
echo "<input type='hidden' name='dg_name' value='view.bkbj'>\n";
...
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['so_number'] == 1 ? ' checked' : '') . " id='col_so_number' name='col[so_number]' type='checkbox'></td><td width='99%'><label for='col_so_number'>SC Number</label></td></tr></table>\n";
...
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['dokumen'] == 1 ? ' checked' : '') . " id='col_dokumen' name='col[dokumen]' type='checkbox'></td><td width='99%'><label for='col_dokumen'>No. Surat Jalan</label></td></tr></table>\n";
...
echo "<table cellspacing='0' cellpadding='0' class='datagrid_bar_customize' align='left' width='160'><tr><td width='1'><input" . ($cgx_def_columns['ket'] == 1 ? ' checked' : '') . " id='col_ket' name='col[ket]' type='checkbox'></td><td width='99%'><label for='col_ket'>Ket</label></td></tr></table>\n";
...
function exportCSV() {
    ...
    form.setAttribute("action", "action/view.bkbj.php");
    ...
    hiddenField.setAttribute("value", "<?php echo title_header('view.bkbj', org()); ?>");
    form.appendChild(hiddenField);
...
if ($item_number) $cgx_sqltotal .= " AND m_product.product_code LIKE '%" . mysql_escape_string($item_number) . "%'";
...
if ($cgx_def_columns['ket'] == 1) $cgx_datagrid->addColumn(new Structures_DataGrid_Column('Ket', 'ket', 'ket', array('align' => 'left'), NULL, NULL));
