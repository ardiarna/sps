...
echo "<div class='title'>Forecast<div style='font-size: 12px;'>As of " . date($APP_DATETIME_FORMAT) . "</div></div>";
...
$cgx_datagrid->addColumn(new Structures_DataGrid_Column("$jdl_1", 'bulansatu', 'bulansatu', array('align' => 'right'), NULL, "cgx_format_3digit()"));
$cgx_datagrid->addColumn(new Structures_DataGrid_Column("$jdl_2", 'bulandua', 'bulandua', array('align' => 'right'), NULL, "cgx_format_3digit()"));
$cgx_datagrid->addColumn(new Structures_DataGrid_Column("$jdl_3", 'bulantiga', 'bulantiga', array('align' => 'right'), NULL, "cgx_format_3digit()"));
