...
function cgx_warehouse($data) {
    $href = "module.php?&m={$_REQUEST['m']}&pkey[m_product_id]={$data['record']['m_product_id']}&whouse=y";
    $out = "<a href='{$href}'><img src='images/icon_chart.png' border='0'></a>";
    return $out;
}
...
if (strlen($_REQUEST['pkey']['m_product_id']) > 0) {
    ...
    if (has_privilege('view.stobal')) $cgx_datagrid->addColumn(new Structures_DataGrid_Column(NULL, NULL, NULL, array('align' => 'center', 'width' => '1'), NULL, 'cgx_warehouse()'));
