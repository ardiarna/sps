...
echo "<div class='title'>Stok Slit</div>";
...
function cgx_edit($data) {
    ...
    if (is_array($_SESSION[$GLOBALS['APP_ID']]['view.sslit']['columns'])) {
        $cgx_def_columns = $_SESSION[$GLOBALS['APP_ID']]['view.sslit']['columns'];
    } else {
        ...
        $_SESSION[$GLOBALS['APP_ID']]['view.sslit']['columns'] = $cgx_def_columns;
    }
    ...
    */
    ...
    echo "<input type='hidden' name='dg_name' value='view.sslit'>\n"; // penyebab ga bisa di pilih
    ...
    if ($_SESSION[$GLOBALS['APP_ID']]['view.sslit']['error']) {
        echo "<div class='error'>{$_SESSION[$GLOBALS['APP_ID']]['view.sslit']['error']}</div>";
        unset($_SESSION[$GLOBALS['APP_ID']]['view.sslit']['error']);
    }

    if ($_SESSION[$GLOBALS['APP_ID']]['view.sslit']['info']) {
        echo "<div class='info'>{$_SESSION[$GLOBALS['APP_ID']]['view.sslit']['info']}</div>";
        unset($_SESSION[$GLOBALS['APP_ID']]['view.sslit']['info']);
    }
