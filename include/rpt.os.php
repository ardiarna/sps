...
echo "<div class='title'>Outstanding Sales Order</div>";

echo "<div class='data_box'>";
echo "<table>";
//echo "<tr>";
//echo "<td style='padding-right: 40px;'>Periode</td>";
...
//
echo "<tr>";
echo "<td style='padding-right: 40px;'>Output</td>";
...
//    jasperto = [to.getFullYear(), to.getMonth()+1, to.getDate()].join('-');
    ...
    hiddenField.setAttribute("value", "/reports/SPS/Outstanding_Sales_Order");
