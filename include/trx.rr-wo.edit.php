...
if ($_REQUEST['mode'] != 'edit') {
    ...
    $select_wo = "<img onclick=\"popupReference('work-order-lp');\" style='cursor: pointer; vertical-align: bottom;' src='images/icon_reference.png'>";
}

if ($_SESSION[$GLOBALS['APP_ID']]['trx.rr-wo']['error']) {
    echo "<div class='error'>{$_SESSION[$GLOBALS['APP_ID']]['trx.rr-wo']['error']}</div>";
    unset($_SESSION[$GLOBALS['APP_ID']]['trx.rr-wo']['error']);
}

if ($_SESSION[$GLOBALS['APP_ID']]['trx.rr-wo']['info']) {
    echo "<div class='info'>{$_SESSION[$GLOBALS['APP_ID']]['trx.rr-wo']['info']}</div>";
    unset($_SESSION[$GLOBALS['APP_ID']]['trx.rr-wo']['info']);
}
...
if ($_REQUEST['mode'] == 'edit') {
    ...
    $datagrid->addColumn(new Structures_DataGrid_Column('Work Order', 'work_order', NULL, array('align' => 'left'), NULL, NULL));
...
<!--
function setWorkOrder(m_work_order_id, document_no, m_work_order_line_id, order_date, partner_name) {
    ...
    xajax_salesOrderLinesForm(m_work_order_id);
}
