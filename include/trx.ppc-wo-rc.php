...
echo "<td><input type='button' value='Back' onclick=\"window.location = 'module.php?m=trx.ppc-wo-rc1';\"></td>";
echo "</tr></table>";
echo "</form>";
echo "</div>";
...
while ($dtx = mysql_fetch_array($rsx, MYSQL_ASSOC)) {
    ...
    echo "<td align='center' width='1'><input onclick=\"window.location = 'module.php?m=trx.ppc-wo-rc.form&yyyy={$def_year}&ww={$dtx['ww']}';\" type='button' value='Create WO'></td>";
    echo "</tr>";
}
mysql_free_result($rsx);
echo "</table>";
