...
if ($_REQUEST['mode'] == 'edit' && $_SESSION[$APP_ID]['bkpc-wo']['m_bkpc_id'] == $_REQUEST['pkey']['m_bkpc_id']) {
...
echo "<tr>";
echo    "<td width='12%'>Nomor WO {$mandatory}</td>";
echo    "<td width='30%'><input{$readonly} name='sj_no' type='text' size='30' value=\"{$data['sj_no']}\"></td>";
echo    "<td width='6%'></td>";
