...
class Attribute {
	...
	public function getName() { return $this->Item['attrName']; }
	public function getValue() { return $this->Item['attrValue']; }

	public function setName($name) { $this->Item['attrName'] = $name; }
	public function setValue($value) { $this->Item['attrValue'] = $value; }
